    ...
    <div class="container">
        <div class="breadcrumb-content">
            <div class="section-heading pb-3">
                <h2 class="section__title">{{ $post->post_title }}</h2>
            </div>
            ...
            <ul class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center flex-wrap fs-14 pt-2">
                ...
                <li class="d-flex align-items-center">{{ $post->created_at->format('M d Y') }}</li>
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <div class="view-all-course-btn-box">
                                <a href="{{ url('view/all/posts') }}" class="btn theme-btn w-100">View All Posts <i class="la la-arrow-right icon ml-1"></i></a>
                            </div>
                        </div>
                    </div><!-- end card -->
                    <div class="card card-item">
