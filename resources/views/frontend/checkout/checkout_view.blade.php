                    ...
                    <div class="card-body">
                        ...
                        <form method="post" class="row">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="text" placeholder="www.tehcydevs.com">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="text" placeholder="Town/City">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="text" placeholder="Postal / Zip code">
