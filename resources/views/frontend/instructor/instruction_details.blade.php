        ...
        <div class="breadcrumb-content">
            <div class="pb-4 media media-card align-items-center">
                <div class="rounded-full media-img media--img media-img-md">
                    <img class="rounded-full" src="{{ !empty($instructor->photo) ? url('upload/instructor_image/' . $instructor->photo) : url('upload/noimage.jpg') }}" alt="Student thumbnail image">
                </div>
                <div class="media-body">
                    <h2 class="section__title fs-30">{{ $instructor->name}}</h2>
                    <span class="pt-1 pb-2 d-block lh-18">Joined {{ Carbon\Carbon::parse($instructor->created_at)->format('F j Y') }}</span>
            ...
            <ul class="social-icons social-icons-styled social--icons-styled">
                ...
                <li><a href="{{ $instructor->instagram }}"><i class="la la-instagram"></i></a></li>
                <li><a href="{{ $instructor->linkedin }}"><i class="la la-linkedin"></i></a></li>
                <li><a href="{{ $instructor->youtube }}"><i class="la la-youtube"></i></a></li>
            </ul>
        ...
        <div class="card card-item">
            <div class="card-body">
                ...
                <div class="pb-1 d-flex align-items-center">
                    ...
                    <p class="text-success fs-14 font-weight-medium">Updated<span class="pl-1 font-weight-bold">{{ $course->created_at->format('M j Y') }}</span></p>
                </div>
