                ...
                <div class="p-4 card-body">
                    ...
                    <form id="myForm" action="{{ route('update.admindata',$user->id) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="input1" name="email" value="{{$user->email}}">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="input1" class="form-label">Phone</label>
                            <input type="text" class="form-control" id="input1" name="phone" value="{{$user->phone}}">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        {{-- <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="input1" name="password" value="{{$user->password}}">
                        </div> --}}
